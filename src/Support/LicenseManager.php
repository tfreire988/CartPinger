...
final class LicenseManager {
	...
	/**
	 * Returns true when a valid CartPinger supporter license is active.
	 *
	 * No feature in this plugin is gated by this value. The flag exists only so
	 * a separately distributed companion add-on (not hosted on WordPress.org)
	 * can detect supporter status and offer additional integrations.
	 */
